...
### Новые задачи
- [x] Finished tournament editorial: очки рейтинга вынесены прямо в верхний блок по местам/уровням, нижний collapsible рейтинг скрыт для этого турнира ✅ (2026-04-06, `web/components/calendar/FinishedTournamentPage.tsx`, `STATUS.md`)

# Архив: план и архитектура фаз 6–8 (справочник)

> **Назначение:** сохранённые таблицы задач, диаграммы и технические детали по безопасности (фаза 6), мультисудейству (фаза 7) и единой БД рейтингов (фаза 8).  
> **Статус содержимого:** по чеклисту в [`STATUS.md`](../STATUS.md) перечисленные здесь задачи в основном **выполнены**; документ не является активным бэклогом.  
> **Исходный файл:** переименован из `PHASE6_PLAN.md` (2026-04-01).

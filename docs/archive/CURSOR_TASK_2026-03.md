# Архив: задание Cursor (фазы 7–8), март 2026

> **Актуальные документы:** [`README.md`](../../README.md), [`docs/DEVELOPMENT.md`](../DEVELOPMENT.md), [`docs/AGENTS.md`](../AGENTS.md), [`STATUS.md`](../../STATUS.md).  
> Архитектурный справочник: [`docs/ARCHITECTURE_PHASES_6_8.md`](../ARCHITECTURE_PHASES_6_8.md).
...
> **Архитектура (актуальная ссылка):** [`docs/ARCHITECTURE_PHASES_6_8.md`](../ARCHITECTURE_PHASES_6_8.md), `CLAUDE.md`, `STATUS.md`
...
```bash
npm run dev          # Vite dev-сервер (порт см. vite.config.js, по умолчанию 8000)
npm run test:unit

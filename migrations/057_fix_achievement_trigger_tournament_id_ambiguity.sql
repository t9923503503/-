...
BEGIN
  ...
  IF tournament_stats.matches_count > 0 AND tournament_stats.min_balls < 8 THEN
    INSERT INTO player_achievements (player_id, badge_type, metadata)
    VALUES (
      v_player_id,
      'iron_fortress',
      jsonb_build_object('avg_balls_conceded', tournament_stats.min_balls)
    )
